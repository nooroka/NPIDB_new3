...
#coding: utf-8
import os
op = open("/home/nooroka/backup04052021/PF03377/PF03377_structs.txt","r")
w = open("/home/nooroka/backup04052021/PF03377/PF03377_int.txt","w")
w1 = open("/home/nooroka/backup04052021/PF03377/pdbPF03377.txt","w")
listresstructs = []
...
count2 = 0
op3 = open("/home/nooroka/backup04052021/PF03377/PF03377_int.txt","r")
for line3 in op3:
    line3 = line3.strip()
    line3 = line3.split(" ",1)
    if len(line3) > 1:
        if "H-Bb" in line3[1]:
        #if  line3[1] == "H-Bb L-Bb L-Mj":
            print(line3)
            count2+=1
op3.close()

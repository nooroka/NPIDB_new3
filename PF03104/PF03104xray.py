...
op2 = open("/home/nooroka/backup04052021/PF03104/PF03104_int.txt","r")
...
for line2 in op2:
    ...
    '''
    elif linex[0] not in list1 and linex[0] not in list11 and linex[0] not in listel:
        print("listxx[0] "+str(listxx[0]))
    '''
print(len(list11))
print(len(list1))
print(len(listel))

...
#coding: utf-8
import os
op = open("/home/nooroka/backup04052021/PF03104/PF03104_structs.txt","r")
w = open("/home/nooroka/backup04052021/PF03104/PF03104_int.txt","w")
w1 = open("/home/nooroka/backup04052021/PF03104/pdbPF03104.txt","w")
listresstructs = []
...
count2 = 0
op3 = open("/home/nooroka/backup04052021/PF03104/PF03104_int.txt","r")
for line3 in op3:
    line3 = line3.strip()
    line3 = line3.split(" ",1)
    if len(line3) > 1:
